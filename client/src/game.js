import { Player, PlayerAction } from '../proto/tetris_pb.js';
import { TetrisClient } from '../proto/tetris_grpc_web_pb.js';
...
export function startGame() {
    ...
    function connectAndJoinGame() {
        console.log("Botão clicado, a tentar conectar...");
    ...
    // --- EVENT LISTENERS ---
    joinGameBtn.addEventListener('click', connectAndJoinGame);
    ...
    document.addEventListener('keydown', (e) => {
        if (gameScreen.classList.contains('active')) {
            switch (e.key) {
                ...
                case ' ': e.preventDefault(); sendPlayerAction(4); break;
            }
        }
    });
